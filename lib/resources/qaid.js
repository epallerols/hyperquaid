...
module.exports = [{
  ...
  method: "POST",
  path: "/qaids/{qaid}/questions",
  handler: function addAQuestion(request, reply) {
    QAService.createQuestion(request.params.qaid, request.payload, function redirectOnSuccess(error, data) {
      if (error) {
